document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('loginForm').addEventListener('submit', function(e) {
        ...
        setTimeout(() => {
            animatePageTransition('dashboard.html');
        }, 1500);
    });
    ...
    if (registerLink) {
        registerLink.addEventListener('click', function(e) {
            e.preventDefault();
            animatePageTransition('register.html');
        });
    }
...
function initPageAnimations() {
    ...
    const formElements = document.querySelectorAll('.form-group, .signin-btn, .social-login, .register-link');
...
function addRippleEffect() {
    const buttons = document.querySelectorAll('.signin-btn, .social-btn');
